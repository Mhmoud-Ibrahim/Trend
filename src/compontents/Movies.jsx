...
export default function Movies() {
  ...
  let {trending} = useTrending(`https://api.themoviedb.org/3/discover/movie?api_key=f3315c4ac6766b68283c8d019253abdc&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&`)
...
<title>Movies</title>
  ...
  <div className="row  py-5">
    ...
    <div className="brdr w-25 mb-3 "></div>
      ...
      <p className='  text-light-emphasis'>Top Trending Movies By Week</p>
